...
<head>
    ...
    <title>403 Not Have Access | ULT Poliwangi</title>
            ...
            <div class="col-6">
                <div class="card card-rounded">
                    <div class="card-image" data-aos="zoom-in" data-aos-delay="600">
                        <center>
                            <img src="{{ asset('images/403-not-have-access.png') }}" class="img-fluid" width="500"
                                alt="">
                        </center>
                    </div>
                    <div class="card-title text-center mt-3" data-aos="fade-up" data-aos-delay="300">
                        <h3>Anda Tidak di Izinkan <br> Untuk Mengakses Halaman Ini</h3>
                    </div>
